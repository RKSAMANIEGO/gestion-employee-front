...
import { CrudEmployeeContext } from "./CrudEmployeeContext"
import { api } from "../../../../core/api/api";
import axios from "axios";

const CrudEmployeeProvider = ({children}) => {
    ...
    const findById= async(path,id)=>{
     ...
     const postData= async(path,form)=>{
        ...
        const contextValue={data,loading,error,fetchData,postData,putData,deleteData,findById}
  return (
    <CrudEmployeeContext.Provider  value={contextValue}>
        {children}
    </CrudEmployeeContext.Provider>
  )
}

export default CrudEmployeeProvider